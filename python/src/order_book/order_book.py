...
class OrderBook:
    ...
    def is_empty(self) -> bool:
        return self.best_bid() is None and self.best_offer() is None
    ...
    def __len__(self) -> int:
        return len(self.offers) + len(self.bids)
    ...
    def trade_top(
        ...
        if best.volume == volume_to_trade:
            ...
            self.amend_order(best.order_id, order.inverse_side,
                             best.volume - volume_to_trade)
